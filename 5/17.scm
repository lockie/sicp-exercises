...
(define (make-new-machine)
  (let ((pc (make-register 'pc))
    ...
    (let ((the-ops
      ...
      (define (print-labels inst all-labels)
          (cond ((null? all-labels) nil)
                ((null? (cdar all-labels)) nil)
                ((eq? inst (caadar all-labels))
                 (display (caar all-labels)) (display ".") (newline))  ; assembler style ^_^
                (else
                 (print-labels inst (cdr all-labels)))))
      (define (execute)
