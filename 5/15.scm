    ...
    (let ((the-ops
      ...
      (define (dispatch message)
        (cond ((eq? message 'start)
              ...
              ((eq? message 'advance-instruction-counter)
               (lambda () (set! instruction-counter (+ instruction-counter 1))))
...
(define (advance-pc machine pc)
    ((machine 'advance-instruction-counter))
...
((fib-machine 'print-instruction-counter))

(newline)
((fib-machine 'reset-instruction-counter))
