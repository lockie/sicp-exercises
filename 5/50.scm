...
(define (primitive-procedure-objects)
    (map make-primitive-procedure (map cadr primitives)))
...
(define operations
    (list
     (list 'cons cons)
     (list 'false? false?)
     (list 'list list)  ;; ... а зомби зомби зомби :D
...
(define interpreter-machine
    (make-machine
     '(env proc argl continue val)
     operations
     (caddr bytecode)))

(set-register-contents! interpreter-machine 'env (setup-environment))
(start interpreter-machine)
