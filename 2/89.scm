...
(define (adjoin-term term term-list)
    (let ((term-order (order term))
        ...
        (cond ((=zero? (coeff term)) term-list)
              ((= term-order (- list-length 1)) (adjoin-term term (cdr term-list)))
              ((< term-order list-length) (cons (car term-list) (adjoin-term term (cdr term-list))))
              ((> term-order list-length) (adjoin-term term (cons 0 term-list)))
